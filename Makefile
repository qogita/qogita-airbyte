...
copy_env_file:
	scp -i $(HOME)/.ssh/airbyte.pem ${DIR}/.env.prod ec2-user@ec2-18-132-194-109.eu-west-2.compute.amazonaws.com:~/.env.prod
...
move_env_file_to_root_folder:
	ssh ec2-user@$(SERVER) 'sudo cp ~/.env.prod /.env.prod';
